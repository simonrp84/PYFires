...
def main(curfile, out_dir):
    ...
    #scn.save_dataset('VI1_RAD', base_dir=out_dir, enhance=False, dtype=np.float32)
    #scn.save_dataset('MIR_RAD', base_dir=out_dir, enhance=False, dtype=np.float32)
    save_output(scn, results, 'outarr_night', out_dir, 'VI1_DIFF')
    #scn.save_dataset('VI2_RAD', base_dir=out_dir, enhance=False, dtype=np.float32)
    #scn.save_dataset('VI1_DIFF', base_dir=out_dir, enhance=False, dtype=np.float32)
